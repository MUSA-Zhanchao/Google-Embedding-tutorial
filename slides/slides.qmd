...
::: {.column width="50%"}
![](images/pdfm5.png){top="0" width="700" height="450"}
:::
:::::
...
::: {.column width="50%"}
![](images/PDFM1.jpg){top="0" width="700" height="450"}
:::
:::::
...
![](images/pdfm3.png){top="0" width="900" height="550"}
...
::: {.column width="50%"}
![](images/satellite-app.png){height=500px}
:::
:::::
...
<br>
<br>
<div style="font-size: 1.3em; font-weight: bold; margin-bottom: 1.2em;">
  Powerful GeoAI tools, but use with caution and critical thinking!
</div>

<div style="font-size: 1.3em; font-weight: bold; font-style: italic;
            border-top: 2px solid #ccc; padding-top: 1.0em;">
